  ...
  return new Promise((resolve, reject) => {
    if (timeLeft < 1000) {
      ...
      setTimeout(() => {
          ...
          resolve(timeLeft); // why do we need to do timeLeft instead of just resolve()?
      }, 1000)
  }
  })
}
...
function workout(totalTime) {
  ...
  // Your code here 
  stretch(totalTime)
    .then((timeLeftrun) => runOnTreadmill(timeLeftrun))
    .then((timeLeftlift) => liftWeights(timeLeftlift))
